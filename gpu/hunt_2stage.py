"""hunt_2stage.py — GPU hunt for 2M+ mushroom islands, random seeds.

K=2 at 1x step — proven reliable. Random seeds for uniform sampling.
Logs to islands_2m.jsonl: seed, area, cx, cz.
"""
